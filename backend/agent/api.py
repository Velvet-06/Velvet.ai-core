...
from run_agent_background_redis import run_agent_background, _cleanup_redis_response_list, update_agent_run_status
...
async def get_agent_runs(thread_id: str, user_id: str = Depends(get_current_user_id_from_jwt)):
    ...
    client = await db.client
    # Temporarily bypass access checks to unblock MVP
    # TODO: restore verify_thread_access when auth is stable
